...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_NO_DESTROY TransDefaultTypeInternal _Trans_default_instance_;
constexpr Quat::Quat(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : w_(0)
  , x_(0)
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_NO_DESTROY QuatDefaultTypeInternal _Quat_default_instance_;
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_NO_DESTROY KeyFrameDefaultTypeInternal _KeyFrame_default_instance_;
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_NO_DESTROY KeyFramesDefaultTypeInternal _KeyFrames_default_instance_;
}  // namespace scan_context_io
...
descriptor_table_key_5fframes_2eproto_metadata_getter(int index) {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_key_5fframes_2eproto);
  return descriptor_table_key_5fframes_2eproto.file_level_metadata[index];
}
